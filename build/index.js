...
Module['FS_createPath']("/src/assets", "obj", true, true);
Module['FS_createPath']("/src", "shaders", true, true);
   ...
   loadPackage({"files": [{"filename": "/src/assets/textures/arm.png", "start": 0, "end": 601, "audio": 0}, {"filename": "/src/assets/textures/body.png", "start": 601, "end": 1909, "audio": 0}, {"filename": "/src/assets/textures/face.png", "start": 1909, "end": 3113, "audio": 0}, {"filename": "/src/assets/textures/leg.png", "start": 3113, "end": 3738, "audio": 0}, {"filename": "/src/assets/textures/move.png", "start": 3738, "end": 17155, "audio": 0}, {"filename": "/src/assets/obj/book.obj", "start": 17155, "end": 267898, "audio": 0}, {"filename": "/src/shaders/bg.frag", "start": 267898, "end": 268116, "audio": 0}, {"filename": "/src/shaders/bg.vert", "start": 268116, "end": 268436, "audio": 0}, {"filename": "/src/shaders/charging.frag", "start": 268436, "end": 269769, "audio": 0}, {"filename": "/src/shaders/charging.vert", "start": 269769, "end": 270167, "audio": 0}, {"filename": "/src/shaders/grid.frag", "start": 270167, "end": 270679, "audio": 0}, {"filename": "/src/shaders/grid.vert", "start": 270679, "end": 270828, "audio": 0}, {"filename": "/src/shaders/lightning.frag", "start": 270828, "end": 275335, "audio": 0}, {"filename": "/src/shaders/lightning.vert", "start": 275335, "end": 275687, "audio": 0}, {"filename": "/src/shaders/sprite.frag", "start": 275687, "end": 275847, "audio": 0}, {"filename": "/src/shaders/sprite.vert", "start": 275847, "end": 276236, "audio": 0}, {"filename": "/src/shaders/sprite_selected.frag", "start": 276236, "end": 276870, "audio": 0}, {"filename": "/src/shaders/static_sprite.frag", "start": 276870, "end": 277030, "audio": 0}, {"filename": "/src/shaders/static_sprite.vert", "start": 277030, "end": 277449, "audio": 0}], "remote_package_size": 277449, "package_uuid": "ffd493f9-ed80-4b54-a86a-6ec7ce9fad26"});
...
var ASM_CONSTS = {
  81448: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 82903: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 83892: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 83985: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 84054: function() {return screen.width;},  
 84079: function() {return screen.height;},  
 84105: function() {return window.innerWidth;},  
 84135: function() {return window.innerHeight;},  
 84166: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 84261: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 84398: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 84622: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 85115: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
